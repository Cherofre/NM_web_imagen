...
## Current Snapshot
- Last Updated: 2026-08-21 15:10 +08:00
- Phase: v1.1.0 desktop UX follow-up, triangle application icon, and modal settings verification
...
- Latest Verification: Node 170/170, Studio size rules, TypeScript/Vite production build, `cargo fmt --check`, `cargo check --offline`, and a fresh `npm run desktop:build` with the modal settings dialog passed. Prior installer/package/coexistence and debug-console evidence remains valid; installer/portable artifacts have not been rebuilt for this UI-only follow-up
