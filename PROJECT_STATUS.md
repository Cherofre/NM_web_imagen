...
- Package matrix: canonical ZIP contains 52 release files plus one zero-length directory entry; package SHA256 is `28479e4d98c2afc68e2f1205da4fc904d8c59604291fdcd300db6a646cf766a4`; bundled portable Python smoke and LocalOnly preflight passed; package smoke instance ID was `4614de80a561a871d33d`. Compared with `51f75e…`, all 53 ZIP entries have identical names, order, content hashes, lengths, and compressed lengths; only 11 entry timestamps changed after the fresh frontend build/package pass.
...
- G: sync: `sync_release_to_g.ps1 -SkipPackage` and full `release_preflight.ps1 -ExpectedVersion 1.0.6` passed after the fresh rebuild. The destination has 52 files, zero forbidden items, no sync temp directories, and the same final SHA256 `28479e4d98c2afc68e2f1205da4fc904d8c59604291fdcd300db6a646cf766a4`; v1.0.5 SHA256 remains `7c8e671fb1c00141243cd84427b0c202e9e2be9e8ef23d9537c93787fbe77109`.
