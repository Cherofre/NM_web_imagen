...
- Current Focus: broad prompts stay non-blocking, and model-chosen object replacement receives a stronger intent expansion inside the existing single image-edit request. No preliminary chat/Responses/vision request will be added.
