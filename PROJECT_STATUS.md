...
- Current Focus: continue v1.1.1 desktop usability work on `codex/desktop-distribution-cn`; the published v1.1.0/G: distribution remains unchanged until this branch is explicitly released. Latest fix changes generated-image downloads to a backend attachment URL so WebView2 does not need a cross-origin Blob fetch.
