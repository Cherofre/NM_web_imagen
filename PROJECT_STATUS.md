...
- Latest Verification: 171/171 Node tests, 251/251 Python tests, Python compilation, Vite/TypeScript build, Rust fmt/check/check-locked, Rust unit tests, PyInstaller backend rebuild, and Tauri release build passed. Manual tray/notification interaction remains pending because the installed NM Image Studio instance is currently running and was not interrupted.
