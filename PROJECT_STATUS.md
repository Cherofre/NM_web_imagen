...
- Latest Native Download Verification: desktop build, Rust `cargo check --locked`, frontend build, and the 59 desktop/UI Node tests pass. The deployed EXE hash is `ACEC71E7F534AF82870103B0500F1686213CF1DFF19BDC8BD89EC999F50DCA29`; the previous deployed pair is backed up under `I:\Program\NM Image Studio\_backup-native-download-20260827-150213`. The desktop app was left stopped for manual testing.
