...
## Active Decisions
- 2026-07-11: The first synced v1.0.6 candidate (`958334899120e934b82ce786c803616562ad87e45b37b8f4b6d5d966ce6e019d`) is rejected by final whole-branch review and must not be treated as the release. Five reproduced Important gaps require TDD fixes, a new package/hash, G: overwrite, destination preflight, and another complete review before branch finishing.
- 2026-07-11: v1.0.6 was synchronized only after all local tests, build, exact-manifest package, extracted-package smoke, API/browser smoke, LocalOnly preflight, and independent reviews passed. The clean G: folder and versioned ZIP contain 52 release files with SHA256 `958334899120e934b82ce786c803616562ad87e45b37b8f4b6d5d966ce6e019d`; the v1.0.5 ZIP remains as rollback. Any later packaged-file change invalidates this evidence and requires rebuild plus destination resync.
