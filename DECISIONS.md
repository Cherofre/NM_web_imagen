...
## Active Decisions
- 2026-07-11 — Status: active: The verified v1.0.6 candidate is SHA256 `51f75e9d001cbee5529905dcc106568bdc4142f87416dbe8fdda08061e2dc9a7`. It passed the expanded Python 215/215 and Node 101/101 matrices, build/compile/PowerShell/package/portable-runtime/LocalOnly gates, API/browser smoke, G: overwrite, and full destination preflight. The rejected `958334899120e934b82ce786c803616562ad87e45b37b8f4b6d5d966ce6e019d` candidate and the intermediate `c355…` candidate are superseded. A final whole-branch review is still required before branch finishing.
